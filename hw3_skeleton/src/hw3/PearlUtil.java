...
public class PearlUtil {
     ...
     * @param records a parallel array of <code>MoveRecord</code>, consistent with the state sequence
     *                (possibly null)
     ...
     * @return index of first movable block encountered when searching towards
     ...
     *
     * @param states  a valid state sequence in which movable blocks, if any, are at the far right only
     * @param records a parallel array of <code>MoveRecord</code>, consistent with the state sequence
     *                (possibly null)
     * @param dir     direction of the move, for the purpose of determining whether spikes may be deadly
     ...
     * @param records parallel array of <code>Descriptors</code> exactly matching the cell sequence, possibly null
     */
